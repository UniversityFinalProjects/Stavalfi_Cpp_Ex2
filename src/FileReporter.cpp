...
void FileReporter::report(const CurrentGameState &gameState) const {
    ...
    writer << "----------------------------" << std::endl;
    writer << "------ITERATION REPORT------" << std::endl;
    writer << "----------------------------" << std::endl;

    writer << std::endl << "players: " << std::endl;
